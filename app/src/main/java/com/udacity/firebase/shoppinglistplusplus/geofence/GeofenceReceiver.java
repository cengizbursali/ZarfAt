package com.udacity.firebase.shoppinglistplusplus.geofence;
...
public class GeofenceReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (/*userEncodedMail.equals(receiverEncodedEmail) && */(geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER ||
            ...
            // Log the error.
            Log.e(TAG, getContext().getString(R.string.geofence_transition_invalid_type, geofenceTransition));
        }
    }
    ...
    private String getTransitionString(int transitionType) {
        switch (transitionType) {
            ...
            default:
                return getContext().getString(R.string.unknown_geofence_transition);
        }
    }
